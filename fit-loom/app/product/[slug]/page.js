    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-18 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          {/* Product Image */}
          <div className="lg:w-1/2 w-full lg:h-auto h-96 relative rounded overflow-hidden">
            <Image
              src="https://m.media-amazon.com/images/I/61bStD2ua2L._SY879_.jpg"
              alt="ecommerce"
              fill
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mb-4">
              ...
              <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2">
                {["facebook", "twitter", "message"].map((_, idx) => (
                  <a key={idx} className="text-gray-500 cursor-pointer">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              ...
              <div className="flex">
                ...
                {["bg-white", "bg-black", "bg-pink-500"].map((color, i) => (
                  <button
                    key={i}
